...
export const useUserList = (params: GetUserListParams) => {
  return useSWR<{ data: UserList }>([`${apiBasePath}/platform/user/query`, params], {
    fetcher: (url: string) =>
      request(url, {
        method: 'POST',
        data: params,
...
export async function deleteUser(params: { name: string }): Promise<BaseResponse> {
  return request(`${apiBasePath}/platform/user/delete`, {
    method: 'POST',
    data: params,
  });
}
...
export async function updateUser(params: UserItem): Promise<BaseResponse> {
  return request(`${apiBasePath}/platform/user/update`, {
    method: 'POST',
    data: params,
  });
}
...
export async function addUser(params: UserItem): Promise<BaseResponse> {
  return request(`${apiBasePath}/platform/user/add`, {
    method: 'POST',
    data: params,
  });
}
...
export async function checkName(name: string): Promise<BaseResponse> {
  return request(`${apiBasePath}/platform/user/checkname?name=${name}`);
}
